    ...
    <tbl v-if="!scrollY" v-bind="tableProps" sm datatable>
      ...
      <tbl-body>
        <tr v-for="(row, rowIndex) in rows" :key="`row-${rowIndex}`">
          ...
          <td>
            <a href="#!" @click="rowUpHandler(rowIndex)" class="indigo-text table-up"><fa icon="long-arrow-alt-up"/></a>
            <a href="#!" @click="rowDownHandler(rowIndex)" class="indigo-text table-down"><fa icon="long-arrow-alt-down"/></a>
          </td>
          <td>
