          ...
          <tooltip trigger="hover" :options="{placement: 'top'}" :ref="'stepContent'+index">
            <div class="tooltip">
              ...
              <btn :class="stepButtonClass"
                    ...
                    waves
              >
                <mdb-icon :icon="step.icon" :far="step.far || step.regular" :fal="step.fal || step.light" :fab="step.fab || step.brands" />
              </btn>
          </tooltip>
        </div>
      </div>
...
<script>
import Tooltip from '../../Advanced/Tooltip';
    ...
    if (this.$slots.content) {
      ...
      allChildren.forEach(vnode => {
        if (vnode.componentOptions) {
          ...
          const far = vnode.componentOptions.propsData.far;
          const fab = vnode.componentOptions.propsData.fab;
          const regular = vnode.componentOptions.propsData.regular;
          const brands = vnode.componentOptions.propsData.brands;
          ...
          let step = { icon, far, fab, regular, brands, name, thisStepNumber, activeStep };
...
.steps-form-2 .steps-row-2 .steps-step-2 .btn-circle-2:hover {
    ...
    background-color: white !important; }
.steps-form-2 .steps-row-2 .steps-step-2 .btn-circle-2 .fas, .steps-form-2 .steps-row-2 .steps-step-2 .btn-circle-2 .far, .steps-form-2 .steps-row-2 .steps-step-2 .btn-circle-2 .fab {
    font-size: 1.7rem; }
...
.steps-form-3 .steps-row-3 .steps-step-3 .btn-circle-3:hover {
    ...
    color: #4285F4 !important;
    background-color: white !important; }
.steps-form-3 .steps-row-3 .steps-step-3 .btn-circle-3 .fas, .steps-form-3 .steps-row-3 .steps-step-3 .btn-circle-3 .far, .steps-form-3 .steps-row-3 .steps-step-3 .btn-circle-3 .fab {
    font-size: 1.7rem; }
</style>
